...
The `HSIarimean` function returns a value of habitat quality between zero and one (ignoring NA values).
...
The `HSIwarimean` function returns a value of habitat quality between zero and one (ignoring NA values).
...
The `HSIgeomean` function returns a value of habitat quality between zero and one (ignoring NA values).
...
The `HSImin` function returns a value of habitat quality between zero and one (ignoring NA values).

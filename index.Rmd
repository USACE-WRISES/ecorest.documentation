...
* Comparison of Single-Site Habitat Restoration Alternatives with CEICA(Huron Island)  
...
# Habitat outputs over time for each alternative
FWOP <- c(10, 10, 10, 10, 10, 10)
AltA <- c(10, 18, 22, 25, 26, 26)
AltB <- c(10, 20, 28, 32, 34, 34)
AltC <- c(10, 22, 30, 35, 37, 38)

# Project costs in millions of dollars
cost <- c(0.0, 3.8, 6.2, 9.5)
